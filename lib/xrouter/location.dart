...
import 'package:gdsc_uos_atttendance/xscreen/group_participants_screen.dart';
import 'package:gdsc_uos_atttendance/xscreen/notification_screen.dart';
import '../zconst/size.dart';
import '../zdomain/group.dart';
import '../xscreen/group_host_screen.dart';
import '../xscreen/main_screen.dart';
import '../xscreen/setting_screen.dart';
...
class SettingLocation extends BeamLocation{
  ...
  List<BeamPage> buildPages(context, state){
    ...
    return [
      BeamPage(
          child: SettingScreen(), key: const ValueKey('setting')),
    ];

  }

  @override
  List<Pattern> get pathPatterns => ["/setting"];
